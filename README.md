...
- **[Optimal S&P Position Prediction Model]([link](https://github.com/aydiny/hull-tactical-market-prediction))** - An ensemble LightGBM approach to estimate optimal market position. 
